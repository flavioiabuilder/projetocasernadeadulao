# CMP-07 — Item curricular

| Campo                          | Conteúdo                                                                           |
| ------------------------------ | ---------------------------------------------------------------------------------- |
| 1. ID e nome                   | CMP-07 — Item curricular                                                           |
| 2. Camada                      | Componente                                                                         |
| 3. Status                      | CANDIDATO (`0.1.0-candidate`)                                                      |
| 4. Problema                    | Linha de módulo/encontro com meta e estado                                         |
| 5. Quando usar                 | Listas e matrizes curriculares                                                     |
| 6. Quando não usar             | Card de deck storytelling                                                          |
...
| 9. HTML nativo                 | `<article>` ou `<li>` com heading                                                  |
| 10. Semântica / nome acessível | Nome pelo texto ou `aria-label` se só ícone                                        |
| 11. API pública                | Elemento + classes `dc-curriculo` + atributos nativos / `data-*`                   |
| 12. Variantes                  | Ver classes; não proliferar                                                        |
| 13. Tamanhos                   | Só se meta 44×44 exigir padding                                                    |
| 14. Tokens semânticos          | --tipografia-secao-titulo, --cor-texto-suave, CMP-05                               |
| 15. Estados                    | default; conteúdo longo APLICÁVEL                                                  |
...
| 22. Exemplo correto            | `design-system/laboratorio/` seção CMP-07                                          |
...
| 26. Evidências                 | direcao-a curriculo; prospecto modulos-lista/matriz                                |
