# Movimento III — O Programa · Seções 8 a 11

> Texto literal para o site. Não parafrasear. Fontes: Guia Mestre v1.0-RC
> (arquitetura, ritmo, estrutura da lição) e descrição factual do material
> produzido do Módulo 1 (camadas impressas e exclusivos do Instrutor).

---

## Seção 8 — Arquitetura do programa

**Sobrelinha:** `COMO O CAMINHO SE ORGANIZA`
**Título:** `Quatro módulos, quarenta e oito lições`
...
- Currículo anual completo — 48 lições em quatro módulos, em narrativa unificada
- Módulos de socorro para crises específicas (apêndices pastorais)
- Diretrizes de vida, método e cuidado para o instrutor
- Ritos de passagem e transições simbólicas como marcos comunitários de gratidão e envio

**Fora do escopo:**

- Debates confessionais secundários
- Políticas institucionais
- Tratamentos clínicos — encaminhados à capelania e a profissionais de saúde

---

## Seção 9 — Matriz curricular

**Sobrelinha:** `AS QUARENTA E OITO LIÇÕES`
**Título:** `Matriz curricular`
...
**Sobrelinha:** `COMO UMA LIÇÃO SE ESTRUTURA`
**Título:** `Anatomia de uma lição`
...
**Sobrelinha:** `ALUNO, INSTRUTOR E O ENCONTRO`
**Título:** `As duas edições e o encontro`
