# Movimento II — A Resposta · Seções 5 a 7

> Texto literal para o site. Não parafrasear, não resumir, não "melhorar".
> Continuação direta do Movimento I. O leitor acabou de aceitar o diagnóstico;
> agora vê o que se decidiu fazer com ele.

---

## Seção 5 — A convicção

**Sobrelinha:** `O QUE SUSTENTA TUDO`
**Título:** `Cristo chama, treina, molda e envia`
...
**Sobrelinha:** `O QUE ESTE PROJETO NÃO FAZ`
**Título:** `Quatro recusas deliberadas`
