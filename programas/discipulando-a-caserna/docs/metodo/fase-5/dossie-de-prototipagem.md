...
| F5-08 | Escolha | Pendente humano |
| F5-09 | Descartas | Pendente (histórico já justificado como baseline) |
| F5-10 | Canonizar | Pendente |
| F5-11 | Pages | Default: **não** publicar (pages.yml intacto) |
| F5-12 | Abrir Fase 6 | BLOQUEADA |
