...
| [`prospecto-fase-5-v1/`](prospecto-fase-5-v1/)         | Canônico técnico Fase 5 — prévia pública **SUSPENSA** | Não   |
...
Allowlist: [`../docs/publicacao/estado-publicacao.json`](../docs/publicacao/estado-publicacao.json)
· Decisão: [`../docs/publicacao/PUB-F5-01.md`](../docs/publicacao/PUB-F5-01.md).
