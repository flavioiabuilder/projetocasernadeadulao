...
| 6    | Implementação            | Código em repositório  | [`fases/fase-6-implementacao.md`](fases/fase-6-implementacao.md)       | **LIBERADA** após F5-12 (`autorizacaoFase6: true`) — **não iniciada**. Sem criar `prospecto/`; sem publicar; Pages/`noindex` intactos; runtime ainda `prospecto-v1` | **LIBERADA (não iniciada)**     |
