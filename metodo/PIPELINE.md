...
| 5    | Prototipagem com IA      | Protótipo aprovado     | [`fases/fase-5-prototipagem.md`](fases/fase-5-prototipagem.md)         | [`docs/metodo/fase-5/`](../programas/discipulando-a-caserna/docs/metodo/fase-5/) + candidato `prototipos/prospecto-fase-5-v1/` — canônico pendente de decisão humana | **CANDIDATO EM VALIDAÇÃO** |
| 6    | Implementação            | Código em repositório  | [`fases/fase-6-implementacao.md`](fases/fase-6-implementacao.md)       | **BLOQUEADA** até F5-12 (`autorizacaoFase6: false`). Blueprint em `docs/metodo/fase-6/`; runtime Pages ainda `prospecto-v1` | **BLOQUEADA**     |
