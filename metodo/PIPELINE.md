...
| 5    | Prototipagem com IA      | Protótipo aprovado     | [`fases/fase-5-prototipagem.md`](fases/fase-5-prototipagem.md)         | [`docs/metodo/fase-5/`](../programas/discipulando-a-caserna/docs/metodo/fase-5/) + candidato `prototipos/prospecto-fase-5-v1/` — canônico pendente de decisão humana | **Aberta**        |
