# Fases 5–8 — guias operacionais

As fases 0–4 têm prompt dedicado em [`../prompts/`](../prompts/) e validação
semântica em `npm run validate:metodo`. As fases 5–8 são a metade do pipeline
em que o método depende mais de julgamento humano do que de script — estes
guias existem para que esse julgamento seja **procedimento**, não improviso.
...
Mapa completo e estado no piloto: [`../PIPELINE.md`](../PIPELINE.md).
