...
Atualizado: 2026-08-07 (sistema de configurações estruturais Mono_1C).
...
| H2 | Arquitetura do logo | **decidido** | Master = logo canônica. Configurações oficiais: Lockup Vertical, Lockup Horizontal. Auxiliares: Wordmark Stacked, Wordmark Horizontal. Rejeitados: compactos e wordmark 3 linhas. Proibido criar colorways sem gate. |
| H2b | Remover `Color_Institucional_Reverso` | **decidido** | **Histórico** — 2026-08-07. |
| H2c | Colorway = somente `Mono_1C` | **decidido** | Fundos escuros → placa `--color-papel`, sem inverter a marca. |
