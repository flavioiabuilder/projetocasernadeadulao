...
const ATO_ABERTURAS = new Set(ATOS.map((a) => a.tela));
...
--easing:cubic-bezier(0.22,1,0.36,1);--dur:280ms;--dur-enter:620ms;--dur-armor:480ms;--rise:1.15rem
}
*,*::before,*::after{box-sizing:border-box}
html{font-size:var(--min-font);scroll-behavior:smooth}
@media(prefers-reduced-motion:reduce){
html{scroll-behavior:auto}
.cold-id,.timeline__linha,.flip-card__inner,.scroll-hint,.screen-inner>* ,.marchas li,.marcas-arco li,.eixo,.pecas-linha li,.verbos li,.apendices article,.grade-48 span,.armor-piece,#armor-bar,.screen--ato::before,.escudo-img,.escudo-wrap,.matriz-filtro,.matriz-tabela tbody tr,.anatomia-btn,.anatomia-panel,.merch-list li,.adulao-comp__word,.adulao-comp__tag,.conta-grande{transition:none!important;animation:none!important;transform:none!important;opacity:1!important}
}
...
/* —— Motion onda 1 —— */
.screen{transition:background-color var(--dur-enter) var(--easing)}
.screen[data-act="0"],.screen[data-act="1"]{background:var(--bg)}
.screen[data-act="2"],.screen[data-act="3"]{background:color-mix(in srgb,var(--creme) 55%,var(--bg))}
.screen[data-act="4"],.screen[data-act="5"]{background:var(--papel)}
.screen[data-act="6"],.screen[data-act="7"]{background:color-mix(in srgb,var(--creme) 70%,var(--papel))}
.screen[data-act="8"]{background:color-mix(in srgb,var(--navy) 4%,var(--bg))}
.screen[data-act="9"]{background:color-mix(in srgb,var(--brass) 5%,var(--papel))}
.screen--ato::before{content:"";position:absolute;left:0;top:12%;bottom:12%;width:2px;background:var(--brass);transform:scaleY(0);transform-origin:center top;opacity:0;pointer-events:none}
@media(prefers-reduced-motion:no-preference){
.screen:not(.is-inview) .screen-inner>:not(.conducao):not(.cold-id){opacity:0;transform:translateY(var(--rise))}
.screen .screen-inner>:not(.conducao):not(.cold-id){transition:opacity var(--dur-enter) var(--easing),transform var(--dur-enter) var(--easing)}
.screen.is-inview .screen-inner>:not(.conducao):not(.cold-id){opacity:1;transform:none}
.screen.is-inview .screen-inner>:nth-child(1){transition-delay:40ms}
.screen.is-inview .screen-inner>:nth-child(2){transition-delay:110ms}
.screen.is-inview .screen-inner>:nth-child(3){transition-delay:180ms}
.screen.is-inview .screen-inner>:nth-child(4){transition-delay:250ms}
.screen.is-inview .screen-inner>:nth-child(5){transition-delay:320ms}
.screen.is-inview .screen-inner>:nth-child(6){transition-delay:390ms}
.screen.is-inview .screen-inner>:nth-child(7){transition-delay:460ms}
.screen.is-inview .screen-inner>:nth-child(8){transition-delay:520ms}
.screen--ato.is-inview::before{opacity:1;transform:scaleY(1);transition:transform .75s var(--easing) .12s,opacity .4s var(--easing) .12s}
.marchas li,.marcas-arco li,.eixo,.pecas-linha li,.verbos li,.apendices article{opacity:0;transform:translateX(-.7rem);transition:opacity .55s var(--easing),transform .55s var(--easing)}
.screen.is-inview .marchas li,.screen.is-inview .marcas-arco li,.screen.is-inview .eixo,.screen.is-inview .pecas-linha li,.screen.is-inview .verbos li,.screen.is-inview .apendices article{opacity:1;transform:none}
.screen.is-inview .marchas li:nth-child(1),.screen.is-inview .marcas-arco li:nth-child(1),.screen.is-inview .eixo:nth-child(1),.screen.is-inview .pecas-linha li:nth-child(1),.screen.is-inview .verbos li:nth-child(1),.screen.is-inview .apendices article:nth-child(1){transition-delay:.15s}
.screen.is-inview .marchas li:nth-child(2),.screen.is-inview .marcas-arco li:nth-child(2),.screen.is-inview .eixo:nth-child(2),.screen.is-inview .pecas-linha li:nth-child(2),.screen.is-inview .verbos li:nth-child(2),.screen.is-inview .apendices article:nth-child(2){transition-delay:.28s}
.screen.is-inview .marchas li:nth-child(3),.screen.is-inview .marcas-arco li:nth-child(3),.screen.is-inview .eixo:nth-child(3),.screen.is-inview .pecas-linha li:nth-child(3),.screen.is-inview .verbos li:nth-child(3){transition-delay:.4s}
.screen.is-inview .marchas li:nth-child(4),.screen.is-inview .marcas-arco li:nth-child(4),.screen.is-inview .eixo:nth-child(4),.screen.is-inview .pecas-linha li:nth-child(4){transition-delay:.52s}
.screen.is-inview .marcas-arco li:nth-child(5),.screen.is-inview .eixo:nth-child(5){transition-delay:.64s}
.timeline__linha{transition:transform 1.1s var(--easing) .35s;animation:none}
.screen.is-inview .timeline__linha{transform:scaleX(1)}
.grade-48 span{transition:background-color .35s var(--easing),transform .35s var(--easing)}
.grade-48 span.on{transform:scale(1.05)}
.ritmo-bar>span{opacity:0;transform:scaleX(.92);transform-origin:left center;transition:opacity .5s var(--easing),transform .5s var(--easing)}
.screen.is-inview .ritmo-bar>span{opacity:1;transform:none}
.screen.is-inview .ritmo-bar>span:nth-child(1){transition-delay:.15s}
.screen.is-inview .ritmo-bar>span:nth-child(2){transition-delay:.28s}
.screen.is-inview .ritmo-bar>span:nth-child(3){transition-delay:.4s}
.screen.is-inview .ritmo-bar>span:nth-child(4){transition-delay:.55s}
.armor-piece{transition:background-color var(--dur-armor) var(--easing),border-color var(--dur-armor) var(--easing),color var(--dur-armor) var(--easing),transform var(--dur-armor) var(--easing),box-shadow var(--dur-armor) var(--easing)}
.armor-piece.filled{box-shadow:inset 0 0 0 1px color-mix(in srgb,var(--papel) 25%,transparent)}
.armor-piece.just-filled{animation:armorLock .55s var(--easing)}
@keyframes armorLock{0%{transform:scale(1)}35%{transform:scale(1.1)}100%{transform:scale(1)}}
#armor-bar{display:flex;opacity:0;visibility:hidden;pointer-events:none;transform:translateY(-110%);transition:opacity var(--dur) var(--easing),transform var(--dur) var(--easing),visibility 0s linear var(--dur)}
#armor-bar.visible{opacity:1;visibility:visible;pointer-events:auto;transform:none;transition:opacity var(--dur) var(--easing),transform var(--dur) var(--easing),visibility 0s}
}
@media(prefers-reduced-motion:reduce){
.screen--ato::before{opacity:1;transform:none}
.timeline__linha{transform:scaleX(1);animation:none}
.ritmo-bar>span,.marchas li,.marcas-arco li,.eixo,.pecas-linha li,.verbos li,.apendices article{opacity:1;transform:none}
#armor-bar{display:none;opacity:1;visibility:visible;transform:none;pointer-events:auto}
...
.anatomia-panel{border-left:2px solid var(--brass);margin:0 0 .65rem;font-size:.95rem;background:color-mix(in srgb,var(--creme) 40%,var(--bg))}
...
#armor-bar{position:fixed;top:0;left:0;right:0;z-index:100;display:flex;align-items:center;justify-content:center;gap:.45rem;padding:.55rem .75rem;background:color-mix(in srgb,var(--bg) 92%,transparent);border-bottom:1px solid var(--traco);backdrop-filter:blur(6px)}
...
/* —— Motion onda 2 —— */
@media(prefers-reduced-motion:no-preference){
.flip-card{transition:border-color var(--dur) var(--easing),transform var(--dur) var(--easing),box-shadow var(--dur) var(--easing)}
.flip-card:hover{border-color:var(--brass);transform:translateY(-2px)}
.flip-card:active{transform:translateY(0)}
.flip-card__inner{transition:transform .58s cubic-bezier(0.34,1.3,0.64,1)}
.flip-card__face{transition:background-color var(--dur) var(--easing)}
.flip-card[aria-pressed=true]{border-color:var(--brass)}
.flip-card[aria-pressed=true] .flip-card__face--front{background:color-mix(in srgb,var(--brass) 6%,var(--papel))}
.flip-card--simbolo .simbolo-nome{transition:color var(--dur) var(--easing)}
.flip-card--simbolo:hover .simbolo-nome{color:var(--brass)}
.escudo-wrap{position:relative;overflow:hidden;transition:border-color var(--dur-enter) var(--easing),box-shadow var(--dur-enter) var(--easing)}
.screen.is-inview .escudo-wrap{border-color:var(--brass);box-shadow:0 12px 28px color-mix(in srgb,var(--navy) 12%,transparent)}
.escudo-img,.escudo-wrap svg{transform:translate3d(var(--px,0),var(--py,0),0) scale(var(--escudo-scale,1));transition:transform .12s linear;will-change:transform}
.screen.is-inview .escudo-img,.screen.is-inview .escudo-wrap svg{--escudo-scale:1.03}
.escudo-wrap::after{content:"";position:absolute;inset:0;background:radial-gradient(ellipse at 50% 35%,color-mix(in srgb,var(--brass-cl) 18%,transparent),transparent 62%);opacity:0;pointer-events:none;transition:opacity var(--dur-enter) var(--easing)}
.screen.is-inview .escudo-wrap::after{opacity:1}
.matriz-filtro{position:relative;transition:background-color var(--dur) var(--easing),color var(--dur) var(--easing),border-color var(--dur) var(--easing),transform var(--dur) var(--easing)}
.matriz-filtro:hover{border-color:var(--navy);transform:translateY(-1px)}
.matriz-filtro--ativa::after,.matriz-filtro[aria-pressed=true]::after{content:"";position:absolute;left:.65rem;right:.65rem;bottom:0;height:2px;background:var(--brass-cl);transform:scaleX(1);transform-origin:center}
.matriz-tabela tbody tr{transition:opacity .38s var(--easing),transform .38s var(--easing),background-color .38s var(--easing)}
.matriz-tabela tbody tr.is-filtering-out{opacity:0;transform:translateY(.35rem);pointer-events:none}
.matriz-tabela tbody tr.is-filtering-in{animation:matrizIn .42s var(--easing)}
@keyframes matrizIn{from{opacity:0;transform:translateY(.45rem)}to{opacity:1;transform:none}}
.matriz-tabela tbody tr:hover td{background:color-mix(in srgb,var(--brass) 6%,transparent)}
.anatomia-btn{transition:background-color var(--dur) var(--easing),border-color var(--dur) var(--easing),padding-left var(--dur) var(--easing)}
.anatomia-btn:hover{padding-left:1.2rem;border-left-color:var(--brass)}
.anatomia-panel:not([hidden]){display:block}
.anatomia-panel{overflow:hidden;max-height:0;opacity:0;padding-top:0;padding-bottom:0;margin:0;transition:max-height .45s var(--easing),opacity .35s var(--easing),padding .35s var(--easing)}
.anatomia-panel.is-open{max-height:18rem;opacity:1;padding:.85rem 1rem 1.1rem}
.merch-list li{transition:border-color var(--dur) var(--easing),transform var(--dur) var(--easing),background-color var(--dur) var(--easing)}
.merch-list li:hover{border-color:var(--brass);transform:translateY(-2px);background:color-mix(in srgb,var(--brass) 6%,var(--papel))}
.checklist label{transition:color var(--dur) var(--easing)}
.checklist input:checked+span{color:var(--navy)}
.checklist li:has(input:checked){opacity:.78}
#btn-copiar,#btn-imprimir{transition:background-color var(--dur) var(--easing),color var(--dur) var(--easing),border-color var(--dur) var(--easing),transform var(--dur) var(--easing)}
#btn-copiar:hover,#btn-imprimir:hover{transform:translateY(-1px)}
.menu-toggle,.modo-toggle,.armor-piece{transition:border-color var(--dur) var(--easing),background-color var(--dur) var(--easing),color var(--dur) var(--easing),transform var(--dur) var(--easing)}
.menu-toggle:hover,.modo-toggle:hover{transform:translateY(-1px)}
.adulao-comp__word{transition:letter-spacing .8s var(--easing),color var(--dur-enter) var(--easing)}
.screen.is-inview .adulao-comp__word{letter-spacing:.22em}
.adulao-comp__tag{opacity:0;transform:translateY(.4rem);transition:opacity .5s var(--easing),transform .5s var(--easing)}
.screen.is-inview .adulao-comp__tag--1{opacity:1;transform:none;transition-delay:.25s}
.screen.is-inview .adulao-comp__tag--2{opacity:1;transform:none;transition-delay:.4s}
.screen.is-inview .adulao-comp__tag--3{opacity:1;transform:none;transition-delay:.55s}
.conta-grande{transition:transform var(--dur-enter) var(--easing),letter-spacing var(--dur-enter) var(--easing)}
.screen.is-inview .conta-grande{letter-spacing:-0.01em}
.eixo{transition:background-color var(--dur) var(--easing),border-color var(--dur) var(--easing),transform var(--dur) var(--easing)}
.screen.is-inview .eixo:hover{background:color-mix(in srgb,var(--navy) 9%,var(--bg));transform:translateX(3px)}
}
@media(prefers-reduced-motion:reduce){
.anatomia-panel{max-height:none;opacity:1}
.anatomia-panel[hidden]{display:none}
.matriz-tabela tbody tr.is-filtering-out{position:static;height:auto;visibility:visible}
.escudo-img,.escudo-wrap svg{transform:none!important}
}
...
function updateArmor(n){
  ...
  pieces.forEach(function(p,i){
    ...
    var should=n>=fillAt;
    var was=p.classList.contains("filled");
    p.classList.toggle("filled",should);
    if(should&&!was){
      p.classList.remove("just-filled");
      void p.offsetWidth;
      p.classList.add("just-filled");
      p.style.transitionDelay=(i*90)+"ms";
      setTimeout(function(){p.classList.remove("just-filled");p.style.transitionDelay="";},700);
    }
  });
}
...
function markInView(el,on){
  if(on)el.classList.add("is-inview");
}
if(reduceMotion){
  screens.forEach(function(el){el.classList.add("is-inview");});
}else if("IntersectionObserver" in window){
  var scrollRoot=deck&&getComputedStyle(deck).overflowY!=="visible"?deck:null;
  var io=new IntersectionObserver(function(entries){
    entries.forEach(function(en){
      markInView(en.target,en.isIntersecting&&en.intersectionRatio>=0.35);
      if(en.target.id==="tela-13"&&en.isIntersecting)runGradeOnce();
    });
  },{root:scrollRoot,threshold:[0.35,0.55]});
...
document.querySelectorAll(".anatomia-btn").forEach(function(btn){
  btn.addEventListener("click",function(){
    ...
    document.querySelectorAll(".anatomia-panel").forEach(function(p){
      p.classList.remove("is-open");
      if(reduceMotion)p.hidden=true;
      else setTimeout(function(el){return function(){if(!el.classList.contains("is-open"))el.hidden=true;};}(p),reduceMotion?0:420);
    });
    if(!open){
...
var filtroAtivo=0;
function applyMatrizFilter(mod){
  filtroAtivo=mod;
  document.querySelectorAll(".matriz-tabela tbody tr").forEach(function(row){
    var m=parseInt(row.dataset.modulo,10);
    var show=filtroAtivo===0||m===filtroAtivo;
    if(reduceMotion){
      row.style.display=show?"":"none";
      row.classList.remove("is-filtering-out","is-filtering-in");
      return;
    }
    if(show){
      if(row.classList.contains("is-filtering-out")||row.style.display==="none"){
        row.style.display="";
        row.classList.remove("is-filtering-out");
        row.classList.add("is-filtering-in");
        setTimeout(function(){row.classList.remove("is-filtering-in");},450);
      }
    }else{
...
document.querySelectorAll(".matriz-filtro").forEach(function(btn){
  btn.addEventListener("click",function(){
    ...
    applyMatrizFilter(parseInt(btn.dataset.modulo,10));
  });
});

var grade=document.getElementById("grade-48");
var gradeDone=false;
function runGradeOnce(){
  if(gradeDone||!grade)return;
  gradeDone=true;
  var cells=grade.querySelectorAll("span");
  cells.forEach(function(el,g){
    setTimeout(function(){el.classList.add("on");},reduceMotion?0:80+g*18);
  });
}
if(grade){
  for(var g=0;g<48;g++){
    var d=document.createElement("span");
    d.style.transitionDelay=(g*18)+"ms";
    grade.appendChild(d);
  }
  if(reduceMotion)runGradeOnce();
}
...
var escudoWrap=document.querySelector(".escudo-wrap");
if(escudoWrap&&!reduceMotion){
  var escudoScreen=escudoWrap.closest(".screen");
  var onMove=function(e){
    if(escudoScreen&&!escudoScreen.classList.contains("is-inview"))return;
    var r=escudoWrap.getBoundingClientRect();
    var x=((e.clientX-r.left)/r.width-0.5)*10;
    var y=((e.clientY-r.top)/r.height-0.5)*8;
    escudoWrap.style.setProperty("--px",x.toFixed(2)+"px");
    escudoWrap.style.setProperty("--py",y.toFixed(2)+"px");
  };
  var reset=function(){
    escudoWrap.style.setProperty("--px","0px");
    escudoWrap.style.setProperty("--py","0px");
  };
  escudoWrap.addEventListener("pointermove",onMove);
  escudoWrap.addEventListener("pointerleave",reset);
}
