...
if (!h.includes('id="s31"') || !h.slice(h.indexOf('id="s31"'), h.indexOf('id="s31"') + 900).includes('De quebrantados, valentes')) {
  h = replaceOnce(
    h,
...
if (h.includes('id="s63a"')) {
  if (h.includes('Pastor, o Guia') || /\bo senhor\b/.test(h.slice(h.indexOf('id="s63a"'), h.indexOf('id="s64"')))) {
